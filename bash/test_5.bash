...
# python3 ./test_RF.py --num_workers 8 --experiment_name "RF" --epoch "300" --task "T1T2_Oasis" --analysis "metrics_no_uncertainty" --dataroot "/mimer/NOBACKUP/groups/naiss2023-6-336/dataset_shared/OASIS-3_filtered_slices"  --phase test --slice_range 0 10000 --mri_modalities t1n t2w --under_sample_dataset
# python3 ./test_RF_aleatoric_two_forward.py --num_workers 8 --experiment_name "RF_aleatoric_two_forward" --task "T1T2_Oasis" --spatial_enc_channels 1 --epoch "240" --analysis "both" --dataroot "/mimer/NOBACKUP/groups/naiss2023-6-336/dataset_shared/OASIS-3_filtered_slices"  --phase train --slice_range 0 10000 --mri_modalities t1n t2w --under_sample_dataset

# python3 ./test_LDM.py  --num_workers 8 --experiment_name "LDM_MRCT" --task "MRtoCT" --epoch "240" --in_ch 6 --out_ch 3 --analysis "metrics_no_uncertainty"
# python3 ./test_LDM_aleatoric_two_forward.py  --num_workers 8 --experiment_name "LDM_aleatoric_two_forward" --task "MRtoCT" --analysis "metrics" --epoch "240" --spatial_enc_channels 3 --in_ch 6 --out_ch 3
...
# python3 ./test_LFM.py  --num_workers 8 --experiment_name "LFM_MRtoCT" --task "MRtoCT" --epoch "240" --in_ch 6 --out_ch 3 --analysis "metrics_no_uncertainty"
python3 ./test_LFM_two_forward.py  --num_workers 8 --experiment_name "LFM_aleatoric_two_forward_MRCT" --task "MRtoCT" --epoch "240" --in_ch 6 --out_ch 3 --spatial_enc_channels 3 --analysis "metrics"
# --dataroot "/mimer/NOBACKUP/groups/naiss2023-6-336/dataset_shared/OASIS-3_filtered_slices"  --phase test --slice_range 0 10000 --mri_modalities t1n t2w --under_sample_dataset

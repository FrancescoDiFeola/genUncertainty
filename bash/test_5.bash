...
# python3 ./test_LFM_two_forward.py  --num_workers 8 --experiment_name "LFM_aleatoric_two_forward_T1T2" --task "T1T2" --epoch "250" --in_ch 6 --out_ch 3 --spatial_enc_channels 3

# python3 ./test_LFM.py  --num_workers 8 --experiment_name "LFM_denoising" --task "denoising" --epoch "250" --in_ch 6 --out_ch 3

...
# python3 ./test_ddpm_aleatoric_two_forward.py  --num_workers 8 --experiment_name "ddpm_aleatoric_two_forward_MRtoCT" --epoch "200" --task "MRtoCT"  --spatial_enc_channels 1
...
# python3 ./test_ddpm.py  --num_workers 8 --experiment_name "ddpm_MRtoCT" --epoch "250" --task "MRtoCT"
...
# python3 ./test_RF_aleatoric_two_forward.py --num_workers 8 --experiment_name "RF_aleatoric_two_forward_denoising" --task "denoising" --spatial_enc_channels 1 --epoch "200"
# python3 ./test_RF_aleatoric_two_forward.py --num_workers 8 --experiment_name "RF_T1T2_aleatoric_two_forward" --task "T1T2" --spatial_enc_channels 1 --epoch "200"
...
python3 ./test_RF.py --num_workers 8 --experiment_name "RF_MRtoCT" --epoch "200" --task "MRtoCT"
# --dataroot "/mimer/NOBACKUP/groups/naiss2023-6-336/dataset_shared/FDG-PEt_CT-lesion/lung_slices" --phase test --slice_range 0 10000 --mri_modalities CT PET --under_sample_dataset
...
# python3 ./test_LFM_two_forward.py  --num_workers 8 --experiment_name "LFM_aleatoric_two_forward_T1T2" --task "T1T2" --epoch "200" --in_ch 6 --out_ch 3 --spatial_enc_channels 3

# python3 ./test_LFM.py  --num_workers 8 --experiment_name "LFM_denoising" --task "denoising" --epoch "200" --in_ch 6 --out_ch 3

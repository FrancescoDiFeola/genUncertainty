...
python3 ./test_ddpm_aleatoric.py  --num_workers 8 --experiment_name "aleatoric_uncertainty_b16_T1T2" --epoch "50" --task "T1T2"
...
# python3 ./test_LDM_aleatoric_two_forward.py  --num_workers 8 --experiment_name "LDM_aleatoric_two_forward_T1T2" --task "T1T2" --epoch "300" --in_ch 6 --out_ch 3 --spatial_enc_channels 3

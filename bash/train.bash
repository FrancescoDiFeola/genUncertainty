...
# python3 ./train_ddpm_aleatoric_two_forward.py --num_workers 32 --experiment_name "two_forward_concatenation_error_variance_T1T2" --output_dir "/mimer/NOBACKUP/groups/naiss2023-6-336/fdifeola/generative_uncertainty/checkpoints/two_forward_concatenation_error_variance_T1T2" # --diff_ckpt "/mimer/NOBACKUP/groups/naiss2023-6-336/fdifeola/uncertainty_diffusion/checkpoints/aleatoric_uncertainty_b16_T1T2/diffusion-ep-450.pth"
python3 ./test_ddpm_aleatoric_two_forward.py  --num_workers 32 --experiment_name "two_forward_concatenation_error_variance_T1T2" --output_dir "/mimer/NOBACKUP/groups/naiss2023-6-336/fdifeola/generative_uncertainty/checkpoints/two_forward_concatenation_error_variance_T1T2" --diff_ckpt "/mimer/NOBACKUP/groups/naiss2023-6-336/fdifeola/generative_uncertainty/checkpoints/two_forward_concatenation_error_variance_T1T2/diffusion-ep-300.pth" --context_ckpt "/mimer/NOBACKUP/groups/naiss2023-6-336/fdifeola/generative_uncertainty/checkpoints/two_forward_concatenation_error_variance_T1T2/spatial_encoder-ep-300.pth"
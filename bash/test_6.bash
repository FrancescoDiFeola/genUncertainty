...
python3 ./test_RF.py --num_workers 8 --experiment_name "RF" --epoch "240" --task "CBCTtoCT" --analysis "metrics_no_uncertainty" # --analysis "sparsification" --MC_sampling
# --dataroot "/mimer/NOBACKUP/groups/naiss2023-6-336/dataset_shared/OASIS-3_filtered_slices"  --phase test --slice_range 0 10000 --mri_modalities t1n t2w --under_sample_dataset
...
# python3 ./test_LFM.py  --num_workers 8 --experiment_name "LFM_MRtoCT" --task "MRtoCT" --epoch "280" --in_ch 6 --out_ch 3 --analysis "metrics_no_uncertainty"
# python3 ./test_LFM_two_forward.py  --num_workers 8 --experiment_name "LFM_aleatoric_two_forward_MRCT" --task "MRtoCT" --epoch "280" --in_ch 6 --out_ch 3 --spatial_enc_channels 3 --analysis "metrics"
# --dataroot "/mimer/NOBACKUP/groups/naiss2023-6-336/dataset_shared/OASIS-3_filtered_slices"  --phase test --slice_range 0 10000 --mri_modalities t1n t2w --under_sample_dataset

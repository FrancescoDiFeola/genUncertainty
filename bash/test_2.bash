...
# python3 ./test_ddpm.py  --num_workers 8 --experiment_name "ddpm" --epoch "120" --task "CBCTtoCT" --analysis "metrics_no_uncertainty"
# python3 ./test_ddpm_aleatoric_two_forward.py  --num_workers 8 --experiment_name "aleatoric_two_forward" --epoch "120" --task "CBCTtoCT" --analysis "both" --spatial_enc_channels 1
...
# python3 ./test_RF.py --num_workers 8 --experiment_name "RF_MRtoCT" --epoch "200" --task "MRtoCT" --analysis "metrics_no_uncertainty"
# --dataroot "/mimer/NOBACKUP/groups/naiss2023-6-336/dataset_shared/OASIS-3_filtered_slices"  --phase test --slice_range 0 10000 --mri_modalities t1n t2w --under_sample_dataset
# python3 ./test_RF_aleatoric_two_forward.py --num_workers 8 --experiment_name "RF_aleatoric_two_forward_MRtoCT" --task "MRtoCT" --spatial_enc_channels 1 --epoch "150" --analysis "both"
...
# python3 ./test_LDM.py  --num_workers 8 --experiment_name "LDM_MRCT" --task "MRtoCT" --epoch "120" --in_ch 6 --out_ch 3 --analysis "metrics_no_uncertainty"
# python3 ./test_LDM_aleatoric_two_forward.py  --num_workers 8 --experiment_name "LDM_aleatoric_two_forward" --task "MRtoCT" --analysis "metrics" --epoch "120" --spatial_enc_channels 3 --in_ch 6 --out_ch 3
# --dataroot "/mimer/NOBACKUP/groups/naiss2023-6-336/dataset_shared/OASIS-3_filtered_slices"  --phase test --slice_range 0 10000 --mri_modalities t1n t2w --under_sample_dataset

# python3 ./test_LFM.py  --num_workers 8 --experiment_name "LFM_MRtoCT" --task "MRtoCT" --epoch "120" --in_ch 6 --out_ch 3 --analysis "metrics_no_uncertainty"
python3 ./test_LFM_two_forward.py  --num_workers 8 --experiment_name "LFM_aleatoric_two_forward_MRCT" --task "MRtoCT" --epoch "120" --in_ch 6 --out_ch 3 --spatial_enc_channels 3 --analysis "metrics"
# --dataroot "/mimer/NOBACKUP/groups/naiss2023-6-336/dataset_shared/OASIS-3_filtered_slices"  --phase test --slice_range 0 10000 --mri_modalities t1n t2w --under_sample_dataset

...
python3 ./test_RF.py --num_workers 8 --experiment_name "RF" --epoch "150" --task "T1T2_Oasis" --analysis "metrics_no_uncertainty" --dataroot "/mimer/NOBACKUP/groups/naiss2023-6-336/dataset_shared/OASIS-3_filtered_slices"  --phase test --slice_range 0 10000 --mri_modalities t1n t2w --under_sample_dataset
#python3 ./test_RF_aleatoric_two_forward.py --num_workers 8 --experiment_name "RF_aleatoric_two_forward" --task "T1T2_Oasis" --spatial_enc_channels 1 --epoch "120" --analysis "both" --dataroot "/mimer/NOBACKUP/groups/naiss2023-6-336/dataset_shared/OASIS-3_filtered_slices"  --phase train --slice_range 0 10000 --mri_modalities t1n t2w --under_sample_dataset

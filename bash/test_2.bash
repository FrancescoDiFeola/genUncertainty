...
# python3 ./test_ddpm_aleatoric_two_forward.py  --num_workers 8 --experiment_name "two_forward_variance_normalized_T1T2" --epoch "300" --task "T1T2"  --spatial_enc_channels 1
...
# python3 ./test_LDM_aleatoric_two_forward.py  --num_workers 8 --experiment_name "LDM_aleatoric_two_forward_denoising" --task "denoising" --epoch "150" --in_ch 6 --out_ch 3 --spatial_enc_channels 3

...
INPUT_ROOT = "/mimer/NOBACKUP/groups/naiss2023-6-336/dataset_shared/SynthRAD2023_dataset/Task1/pelvis"
OUTPUT_ROOT = "/mimer/NOBACKUP/groups/naiss2023-6-336/fdifeola/diffusion/Data/SynthRad2023/Task1/pelvis"
...
for subject in tqdm(subjects):
    ...
    mr_path = os.path.join(subject_dir, "mr.nii.gz")
    ...
    for d in range(mr.shape[2]):
        np.save(os.path.join(out_subject_dir, f"mr_{d:03d}.npy"), mr[:, :, d])

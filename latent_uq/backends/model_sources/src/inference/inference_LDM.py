...
@torch.no_grad()
def run_inference_LDM_self_refining_and_log_uncertainty_calibration_tail_bins(
        diffusion_model,
        autoencoder,
        context_encoder,
        writer,
...
@torch.no_grad()
def run_inference_LDM_vanilla_and_log_MC_sampling_uncertainty_calibration_tail_bins(
        diffusion_model,
        autoencoder,
        condition_batch,
        gt_batch,

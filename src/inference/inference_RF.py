...
import torch
import os
from src.inference.utils import sparsification_curve_fast, random_sparsification_fast, sparsification_curve, random_sparsification, norm_percentile, collect_calibration_data, map_correlations_multi_thresholds, summarize_uncertainty, uncertainty_error_tail_bins_torch
...
@torch.no_grad()
def run_inference_RF_self_refining_and_log_v3_clean_unc_integral_ablation( # in this function the uncertainty is used for iterative refinement without two-forward
        diffusion_model,
        context_encoder,
        dir,
        condition_batch,
...
@torch.no_grad()
def run_inference_RF_vanilla_and_log_MC_sampling_uncertainty_calibration_tail_bins(
        diffusion_model,
        condition_batch,
        gt_batch,
        writer,

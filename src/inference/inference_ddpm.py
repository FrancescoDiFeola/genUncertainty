...
@torch.no_grad()
def run_inference_and_log_v3_clean_unc_integral_ablation(  # no refinement
        diffusion_model,
        context_encoder,
        channels,
        dir,
...
@torch.no_grad()
def run_ddpm_aleatoric_inference_and_log_v2(
        diffusion_model,
        condition_batch,
        gt_batch,
        writer,
...
@torch.no_grad()
def run_ddpm_aleatoric_inference_and_log_v2_sparsification(
        diffusion_model,
        condition_batch,
        gt_batch,
        step,
